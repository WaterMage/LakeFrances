#### Lake Frances - Phosphorus Sorption Index Significant Difference Between Depths

#Setting UP Working Directory
getwd()

# Grabbing PSI data file
PSI=read.csv("data/LF_PSI_ONLY.csv")
names(PSI)

# Selecting data subsets for significance comparison for PSI 10 VS PSI 20
x10<-PSI$PSI_10
y20<-PSI$PSI_20
...
# Selecting data subsets for significance comparison for PSI 10 VS PSI 30
x10<-PSI$PSI_10
y30<-PSI$PSI_30
...
# Selecting data subsets for significance comparison for PSI 20 VS PSI 30
x20<-PSI$PSI_20
y30<-PSI$PSI_30
