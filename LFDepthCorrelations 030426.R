...
lfran<-read.csv("LF_Master_03042026.csv")
head(lfran) 
...
lfran10<-read.csv("LF_Soil_10_data_030426.csv")
names(lfran10)
...
lfran20<-read.csv("LF_Soil_20_data_030426.csv")
names(lfran20)
...
lfran30<-read.csv("LF_Soil_30_data_030426.csv")
names(lfran30)
...
lfrannum<-read.csv("NumsOnly_LF_Master_030426.csv")
names(lfrannum)
...
print(dat10tab)
write.csv(dat10tab,"LF_Soil_10_Cor030426.csv",row.names = TRUE)
...
write.csv(dat20tab,"LF_Soil_20_Cor030426.csv",row.names=TRUE)
...
write.csv(dat30tab,"LF_Soil_30_Cor030426.csv", row.names=TRUE)
...
write.csv(datalltab,"LF_Soil_All_Cor030426.csv", row.names=TRUE)
